...
frenet_frame_calc <- function(vessel_coords){
  ...
  ## Outut changed to list structure to conform with output from vessel_spline_fit  
  ...
  output <- list(tangent = tangent_array, normal = normal_array, binormal = binormal_array, vssl_coords = vessel_coords)
